...
namespace WheelTimer.Utilities
{
    ...
    public struct PreciseTimeSpan : IComparable<PreciseTimeSpan>, IEquatable<PreciseTimeSpan>
    {
        ...
        public TimeSpan ToTimeSpan() => TimeSpan.FromTicks((long)(ticks * ReversePrecisionRatio));

        static long GetTimeChangeSinceStart() => Stopwatch.GetTimestamp() - StartTime;

        public bool Equals(PreciseTimeSpan other) => ticks == other.ticks;

        public override bool Equals(object obj)
        {
            if (obj is PreciseTimeSpan)
            {
                return Equals((PreciseTimeSpan)obj);
            }
        ...
        public int CompareTo(PreciseTimeSpan other) => ticks.CompareTo(other.ticks);
