...
#pragma warning restore 169
        ...
        public override bool TryEnqueue(T e)
        {
            ...
            long consumerIndexCache = ConsumerIndexCache; // LoadLoad
            ...
            do
            {
                ...
                {
                    long currHead = ConsumerIndex; // LoadLoad
        ...
        public int WeakEnqueue(T e)
        {
            ...
            long mask = this.Mask;
            long capacity = mask + 1;
            long currentTail = ProducerIndex; // LoadLoad
            long consumerIndexCache = ConsumerIndexCache; // LoadLoad
            ...
            // look Ma, no loop!
            if (!TrySetProducerIndex(currentTail, currentTail + 1))
            {
                return -1; // CAS FAIL :(
            }
        ...
        {
            long consumerIndex = ConsumerIndex; // LoadLoad
...
#pragma warning restore 169
        ...
        where T : class
    {
        ...
        protected bool TrySetProducerIndex(long expect, long newValue) => Interlocked.CompareExchange(ref producerIndex, newValue, expect) == expect;
    }
...
#pragma warning restore 169
        ...
        where T : class
    {
        ...
        {
            get { return Volatile.Read(ref headCache); }
...
#pragma warning restore 169
        ...
        where T : class
    {
        ...
        {
            get { return Volatile.Read(ref consumerIndex); }
