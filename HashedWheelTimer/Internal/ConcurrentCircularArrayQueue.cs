...
namespace WheelTimer.Internal
{
        ...
        where T : class
    {
        ...
        protected long CalcElementOffset(long index) => RefArrayAccessUtil.CalcElementOffset(index, Mask);
        ...
        protected void SpElement(long offset, T e) => RefArrayAccessUtil.SpElement(Buffer, offset, e);
        ...
        protected void SoElement(long offset, T e) => RefArrayAccessUtil.SoElement(Buffer, offset, e);
        ...
        protected T LpElement(long offset) => RefArrayAccessUtil.LpElement(Buffer, offset);
        ...
        /// <param name="offset">Computed via <see cref="CalcElementOffset"/>.</param>
        /// <returns>The element at the offset.</returns>
        protected T LvElement(long offset) => RefArrayAccessUtil.LvElement(Buffer, offset);

        public override void Clear()
        {
            while (TryDequeue(out T _) || !IsEmpty)
            {
                // looping
            }
        }

        public int Capacity() => (int)(Mask + 1);
    }
